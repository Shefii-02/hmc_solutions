...
<section class="investor-connect py-5">
    <div class="container">
        ...
        <div class="text-center mb-5" data-aos="fade-up">
            <h2 class="fw-bold">Investor Relations</h2>
            <p class="text-muted">
                Let’s build the future of healthcare together.
                Connect with us to explore partnership and investment opportunities.
            </p>
        </div>
        ...
        <div class="row g-4 align-items-stretch">
            ...
            <div class="col-lg-7" data-aos="fade-right">
                <div class="glass-card p-4 h-100">
                    <h5 class="mb-3 text-black-50">📩 Request Investor Information</h5>
                    ...
                    <form>
                        <div class="row g-3">
                            ...
                            <div class="col-md-6 mb-2">
                                <input type="tel" class="form-control" placeholder="Phone / WhatsApp">
                            </div>
                            <div class="col-md-6 mb-2">
                                <input type="text" class="form-control" placeholder="Investment Interest">
                            </div>
                            <div class="col-12 mb-4">
                                <textarea class="form-control" rows="4"
                                    placeholder="Message or Requirement"></textarea>
                            </div>
                            <div class="col-12">
            ...
            <div class="col-lg-5" data-aos="fade-left">
                <div class="glass-card p-4 h-100 text-center d-flex flex-column justify-content-center">
                    <h5 class="mb-3 text-success">💬 Instant WhatsApp Connect</h5>
                    <p class="text-muted">
                        Prefer quick communication?
                        Chat directly with our investor relations team.
                    </p>

                    <a href="https://wa.me/917592997991?text=Hello%20Hayath%20Medicare%20Investor%20Team"
                        target="_blank" class="btn btn-success btn-lg mt-3">
                        Chat on WhatsApp
                    </a>

                    <small class="text-muted mt-3">
                        Response within 24 hours • Confidential discussion
                    </small>
                </div>
            </div>
        ...
        <div class="text-center mt-5" data-aos="fade-up">
            <p class="text-muted small">
                Trusted by healthcare professionals • Transparent governance • Long-term growth vision
            </p>
        </div>
